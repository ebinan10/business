...
const Contact = () => {
  ...
  <div className="w-full h-[2vh] bg-[#ccc] "></div>
    <div className='w-full bg-[#8c92a9] flex-col md:h-[150vh] h-[205vh]  flex justify-center items-center'>
        ...
        <div className="md:w-4/5 w-[100%] h-full flex flex-col justify-center items-center">
            ...
            <div className="w-full h-full  flex md:flex-row flex-col-reverse md:justify-center justify-evenly items-center">
                <div className="md:w-1/2 w-full md:min-h-[45vh] min-h-[125vh] bg-[#ccc] flex flex-col justify-center item-center">
              ...
              <div className="w-full"><h1 className=' md:text-3xl text-xl text-base-100 '> Nuvie drywall & installation enterprise.</h1>
               ...
               <h1 className=' text-base-100 md:text-lg text-md'>  No 60  Ikorodu - Ososun Road, Fadeyi Lagos<br />
                fadeyi Lagos.</h1></div> 
                ...
                <div className="md:w-1/2 w-full flex flex-col justify-center items-center">
                    <div className="w-[95%] md:h-[132vh] h-[50vh] flex justify-center items-center">
